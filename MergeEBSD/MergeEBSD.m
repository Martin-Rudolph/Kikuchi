clear all; close all; addpath('Example');
%% Input
% Plot type
PlotType = 'result'; % all,result,provisional
% Reconstruction type
Recon = 'overlayed'; % cut, overlayed, average, points
% Resolution of reconstruction (not used for points)
GridRes = 300;
% Projection type
Projection = 'sphere'; % sphere, stereo
% Stereo grid
GridColor = 'none';
GridStep = [30,10];
...
PatternList = {'Test_0.bmp',  0.6, [0.5, 0.25], 0,   70;
               'Test_30.bmp', 0.6, [0.5, 0.25], 30,  70;
               'Test_60.bmp', 0.6, [0.5, 0.25], 60,  70;
               'Test_0.bmp',  0.6, [0.5, 0.25], 90,  70;
               'Test_0.bmp',  0.6, [0.5, 0.25], 180, 70;
               'Test_0.bmp',  0.6, [0.5, 0.25], 270, 70;
               };
